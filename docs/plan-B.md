...
| B-5 | 시선 추출 안정화·Heatmap·표준편차 | plan.md §6, Phase 4 | 질문별 EyeTrackingSummary |
...
- VAD, 발화시간, 발화속도, 무음 측정
- MediaPipe 기반 시선 좌표, 유효 프레임 처리, Heatmap과 표준편차
...
- [ ] 평균 시선 위치와 x/y 표준편차가 출력된다.
- [ ] 얼굴·시선 유효 프레임 비율이 출력된다.
